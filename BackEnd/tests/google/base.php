...
function checkServiceAccountCredentialsFile()
{
  ...
  // $application_creds = $path . '/service-account-credentials.json';
  $application_creds = $path . $_ENV['GOOGLE_SERVICE_CREDS'];
...
function getOAuthCredentialsFile()
{
  global $path;
  // oauth2 creds
  $oauth_creds = $path . $_ENV['GOOGLE_OAUTH2_CREDS'];
