...
(1, 1, 0, 'Mario', 'Mario est une série de jeux vidéo de plateforme créée par Nintendo, mettant en vedette le personnage éponyme, Mario. Les joueurs traversent divers niveaux, sautant sur des ennemis et évitant les obstacles pour sauver la princesse Peach du méchant Bowser. Avec des mondes colorés et une jouabilité intuitive, Mario est devenu un pilier du jeu vidéo.', 'adventure.exe', 'b', '2024-01-26 05:00:00', 3.5),
(2, 2, 0, 'Snake', 'Snake est un jeu vidéo classique où le joueur contrôle une ligne qui grandit en longueur, symbolisant un serpent. Le but est de diriger le serpent pour qu\'il mange des objets apparaissant aléatoirement sur l\'écran, ce qui fait grandir le serpent, tout en évitant de heurter les murs ou son propre corps en mouvement.', 'space.exe', 'a,b', '2024-02-06 05:00:00', 4),
(3, 3, 0, 'PingPong', 'Souvent connu sous le nom de Pong, ce jeu vidéo simule une partie de tennis de table. Deux joueurs contrôlent chacun une raquette, représentée par une ligne verticale sur l\'écran, pour frapper une balle de part et d\'autre. Le but est de marquer des points en passant la balle au-delà de l\'adversaire. C\'est l\'un des premiers jeux vidéo d\'arcade et il a posé les bases pour le futur des jeux vidéo.', 'kingdoms.exe', 'a', '2024-01-17 05:00:00', 4.5),
(4, 1, 0, 'Zelda', 'The Legend of Zelda est une série de jeux vidéo d\'aventure créée par Nintendo. Les joueurs explorent un monde fantastique, combattant des monstres, résolvant des énigmes et traversant des donjons pour sauver la princesse Zelda des griffes du méchant Ganon. La série est célèbre pour son exploration ouverte et ses histoires épiques.', 'kitty.exe', '', '2024-01-14 05:00:00', 3),
(5, 5, 0, 'Pacman', 'Pac-Man est un jeu d\'arcade classique où le joueur contrôle Pac-Man, un personnage jaune circulaire, à travers un labyrinthe rempli de pac-gommes et de fruits tout en évitant quatre fantômes. Le but est de manger toutes les pac-gommes pour passer au niveau suivant, tout en utilisant les super pac-gommes pour rendre les fantômes vulnérables temporairement.', '', '', '2024-02-24 05:00:00', 0),
(6, 6, 76, 'Penguin Dash', 'Rejoignez un pingouin aventurier dans une course pleine de défis ! Esquivez icebergs et prédateurs pour battre des records. Collectez étoiles, débloquez bonus et montez dans le classement. Un jeu captivant pour tous !', '', '', '2024-02-24 05:00:00', 0),
(14, 6, NULL, 'q', 'q', NULL, NULL, '2024-03-07 03:42:00', 0);
...
(26, 9, 4, '2024-03-13', 1, 'baaaahhhhhh');
...
(178, 9, 1710806834, '1d722487b59e12086b0e198695c100d5ecb8758c844fd5b3d02fe342686b14f7'),
(179, 9, 1710817102, 'c24c5523b3f09d1c7f713cdad771f32ba0c618faf96ed551cb88b140a5eb1fdd'),
(180, 12, 1710868997, 'c8b823c06209e793c86e47dee07d0157c911eb0bcd583e4a3bee263a09762a09'),
(185, 9, 1710910888, 'fa22f340ff077a59d96afc0f9adf76b0279ff91dc3463566f6f3b3d2867b4120');
...
(1, 'Nintendo Co., Ltd.', '$2y$10$nmakzte3PwS/95V/K2cqUO/EN8nxutO6BYnXVWqBXB63gcvAYdbne', 'john.doe@example.com', 1234567890, NULL, 0, 0, 'Fondée en 1889, Nintendo est une entreprise japonaise pionnière dans l\'industrie du jeu vidéo, célèbre pour des franchises comme Mario et Zelda.', NULL, NULL, '0000-00-00'),
(2, 'Gremlin ', '$2y$10$bD0KtNARFKLJ3e51sxTqv..X91IkIbkASHxccYPWcUhNezNRcjJx6', 'alice.smith@example.com', 987654321, NULL, 0, 0, 'Société de jeux vidéo britannique fondée en 1984, connue pour ses contributions innovantes à l\'industrie avant son acquisition par Infogrames en 1999.', NULL, NULL, '0000-00-00'),
(3, 'Allan Alcorn', '$2y$10$QroH2ylQrU3aqx7zeLMS2eUhuPAgT1byd89aeyv5zpv2vo4B/Vf5C', 'bob.jones@example.com', 555666777, NULL, 0, 0, 'Ingénieur américain, pionnier du jeu vidéo, connu pour avoir créé Pong, l\'un des premiers jeux vidéo d\'arcade, chez Atari en 1972.', NULL, NULL, '0000-00-00'),
(4, 'Nintendo Co., Ltd.', '$2y$10$roDD0M7SrdDJFKwSYhI4qePO1XkHs7C4h5Sn/pEjD6si9RD/OfTqe', 'emma.davis@example.com', 111222333, NULL, 0, 0, 'Fondée en 1889, Nintendo est une entreprise japonaise pionnière dans l\'industrie du jeu vidéo, célèbre pour des franchises comme Mario et Zelda.', NULL, NULL, '0000-00-00'),
(5, 'Namco', '$2y$10$nZV2jn6b1ExK9MHQOZmKY.hjmFnmWanw2XRu5p8.uaj0K5Wie0zzO', 'jane.doe@example.com', 2234567890, NULL, 0, 0, 'Entreprise japonaise de divertissement, fondée en 1955. Réputée pour Pac-Man, elle a marqué l\'âge d\'or du jeu d\'arcade dans les années 1980.', NULL, NULL, '0000-00-00'),
(6, 'john_doe', '$2y$10$xpynWrLMrU.CS/gkl.HszuvgpMtDxQ4QuiFxEIuB4Kxug99zI5gDy', 'addaasda', 33344555, NULL, 0, 0, 'Etudiant passionné de développement de jeux, est le créateur de \"Penguin Dash\", un jeu captivant où un pingouin agile esquive des obstacles dans un monde glacé. Son talent pour la programmation et le design se reflète dans ce jeu qui combine défis et amusement.', NULL, NULL, '0000-00-00'),
(7, 'tostitos', '$2y$10$Sj0mvySDyMjwOdGIO96hmO4DMybe9bxktLb.C/m1rJRjagjRan43.', 'b', NULL, NULL, NULL, 0, NULL, NULL, NULL, '0000-00-00'),
(9, 'Emma_davis', '$2y$10$NZvQjSvdcnKE1vaPrlrZOO4QTjx/nU7HBoLVSgxNRF0y2x3/CZYyq', 'e', 0, NULL, NULL, 0, NULL, 'tttt', 'mlep', '2024-03-05'),
(12, 'poppy', 'poppy', 'poppy', 0, NULL, NULL, 0, NULL, 'fsvdsv', 'vbsdvsdvvs', '2024-03-12');
...
--
ALTER TABLE `gamestags`
  ADD CONSTRAINT `is_tag_from` FOREIGN KEY (`tagId`) REFERENCES `tags` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `is_tag_of` FOREIGN KEY (`gameId`) REFERENCES `games` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `reviews`
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `review_of` FOREIGN KEY (`gameID`) REFERENCES `games` (`id`),
  ADD CONSTRAINT `reviewed_by` FOREIGN KEY (`userID`) REFERENCES `users` (`id`);
...
--
ALTER TABLE `users_downloads`
  ADD CONSTRAINT `downloaded_by` FOREIGN KEY (`userID`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `item_downloaded` FOREIGN KEY (`gameID`) REFERENCES `games` (`id`);
COMMIT;
