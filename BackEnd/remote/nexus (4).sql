...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 07, 2024 at 11:53 AM
...
(15, 1, 1709234951, '3fe754d4f6f63b08c89d7c070dabca7d41936eb5b9c0fb8f13e122fa6c41eeb8');
...
(9, 'testUser123', '$2y$10$ateRNXpi6B7lY7DhPV.4kepnBU1mdeevwRMcuj1DWFptjO2aZBizm', 'testUser@email', NULL, NULL, NULL, 0, NULL, NULL, NULL, '2024-03-06');
...
--
ALTER TABLE `tokens`
  ADD CONSTRAINT `owned_by` FOREIGN KEY (`sub`) REFERENCES `users` (`id`);
...
ALTER TABLE `users_downloads`
  ...
  ADD CONSTRAINT `downloaded_game` FOREIGN KEY (`gameID`) REFERENCES `games` (`id`);
COMMIT;
