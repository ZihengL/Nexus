...
export default {
  ...
  mounted () {
    ...
    .then(data => {
      ...
      this.carouselItems = data.slice(0, 4).map((item) => ({ ...item, image: `https://firebasestorage.googleapis.com/v0/b/nexus-414517.appspot.com/o/Imagejeux%2FMario.png?alt=media&token=c94515c3-03a7-4bf6-8344-80b00012b051` }));
